...
"use strict";
  ...
  (function() {
    ...
    (function () {
      ...
      if (guestInput) {
        /* While typing: update summary live but NEVER clamp — let user finish */
        ...
        /* Only clamp when user leaves the field */
        guestInput.addEventListener('blur', updateGuestCount);
        /* Also handle change (e.g. browser autofill / Enter key) */
        guestInput.addEventListener('change', updateGuestCount);
        /* Select-all on focus so typing replaces the number immediately */
