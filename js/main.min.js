...
if (isMember === forceMember) return; 
...
recipes: [
{ name: 'Cosmopolitan', image: 'https:
{ name: 'Madras', image: 'https:
{ name: 'Margarita', image: 'https:
{ name: 'Tequila Twilight', image: 'https:
]
},
'The Vibrant Classics': {
desc: 'Crowd favorites, classic and contemporary.',
recipes: [
{ name: 'Bourbon Sidecar', image: 'https:
{ name: 'Classic Daiquiri', image: 'https:
{ name: 'Caribbean Cooler', image: 'https:
{ name: 'Manhattan Twist', image: 'https:
]
},
"The Agave Lover's": {
desc: 'Tequila and mezcal, elevated.',
recipes: [
{ name: "Tommy's Margarita", image: 'https:
{ name: 'Oaxacan Gold', image: 'https:
{ name: 'Smoked Pina Sour', image: 'https:
{ name: 'Pineapple Highball', image: 'https:
{ name: 'Mezcal Old Fashioned', image: 'https:
]
},
'Après Spritz Club': {
desc: 'Golden hour \u2014 the bubbles never stop.',
recipes: [
{ name: 'Chairlift Aperol Spritz', image: 'https:
{ name: 'Red Run Campari Spritz', image: 'https:
{ name: 'Golden Hour Limoncello Spritz', image: 'https:
{ name: 'Velvet Gondola Spritz', image: 'https:
{ name: 'Black Diamond Lemon Spritz', image: 'https:
{ name: 'Alpenglow Spritz', image: 'https:
{ name: 'Powder Day Hugo Spritz', image: 'https:
]
},
'Neon Shadows': {
desc: 'For nights that stretch past the plan.',
recipes: [
{ name: 'Velvet Arctic', image: 'https:
{ name: 'Sunset over Milan', image: 'https:
{ name: 'Minted Gold', image: 'https:
{ name: 'Ginger Tropics', image: 'https:
{ name: 'Honeyed Mint Cooler', image: 'https:
]
},
'Bold Frequency': {
desc: 'Depth, spice, and structure.',
recipes: [
{ name: 'Iron Harvest', image: 'https:
{ name: 'Blood & Brine', image: 'https:
{ name: 'The Maple Ledger', image: 'https:
{ name: 'The Flux Old Fashioned', image: 'https:
]
},
"Sharp & Steady": {
desc: "A precision-driven collection where crisp citrus meets the depth of oak, agave, and botanical spirit.",
recipes: [
{ name: 'Velvet Sting', image: 'https:
{ name: 'Green Alchemy', image: 'https:
{ name: 'Maple Mule', image: 'https:
{ name: 'Bitter Halo', image: 'https:
]
},
"Silk & Snap": {
desc: "Smooth pear vodka meets bright citrus in elegant, easy-drinking cocktails.",
recipes: [
{ name: 'Spiced Orchard Mule', image: 'https:
{ name: 'Pear-Peach Silk', image: 'https:
{ name: 'Pear & Orange Smash', image: 'https:
{ name: 'Velvet Pomelo', image: 'https:
{ name: 'Pristine Martini', image: 'https:
]
},
"Clear Coast": {
desc: "Crisp white rum cocktails with bright tropical and citrus notes.",
recipes: [
{ name: 'Steeped Island', image: 'https:
{ name: 'Velvet Reef', image: 'https:
{ name: 'Ruby Spice Mule', image: 'https:
{ name: 'Carbon Blush', image: 'https:
]
},
"Dusk to Agave": {
desc: "Añejo warmth and rich agave flavors as the sun goes down.",
recipes: [
{ name: 'Paloma Gold', image: 'https:
{ name: 'Orchard Spice Highball', image: 'https:
{ name: 'Obsidian Sipper', image: 'https:
{ name: 'Jalisco Manhattan', image: 'https:
{ name: 'Cherry-Apple Cobbler', image: 'https:
]
},
"Molasses Theory": {
desc: "Vermouth-forward cocktails with layered, bittersweet complexity.",
recipes: [
{ name: 'Tropical Resonance', image: 'https:
{ name: 'Lunar Gloss', image: 'https:
{ name: 'The Static Pulse', image: 'https:
{ name: 'Pure Signal', image: 'https:
{ name: 'Kinetic Amber', image: 'https:
]
},
"Fluid Code": {
desc: "Alcohol-free cocktails with bold fruit and botanical energy.",
recipes: [
{ name: 'Velvet Purple', image: 'https:
{ name: 'Solar Flare', image: 'https:
{ name: 'Volt & Velvet', image: 'https:
{ name: 'Neon Flux', image: 'https:
{ name: 'Zesty Vine', image: 'https:
]
},
"The Bold Circuit": {
desc: "Bourbon backbone with bright sparks of tea and citrus.",
recipes: [
{ name: 'Midnight Tea', image: 'https:
{ name: 'Amber Flare', image: 'https:
{ name: 'Green Harvest', image: 'https:
{ name: 'Cointreau Carriage', image: 'https:
]
},
"Love at First Sip": {
desc: "Romance in every pour — vodka, prosecco, and rosy finishes.",
recipes: [
{ name: "Cupid's Spark", image: 'https:
{ name: 'Venetian Valentine', image: 'https:
{ name: 'Love Note', image: 'https:
{ name: "Cupid's Whisper", image: 'https:
{ name: 'Kiss from a Rose', image: 'https:
]
},
"Confessions in Glass": {
desc: "Gin and strawberry secrets with sparkling, floral finishes.",
recipes: [
{ name: 'Velvet Rose', image: 'https:
{ name: 'Sparkling Bouquet', image: 'https:
{ name: 'Cocoa-Berry', image: 'https:
{ name: 'Passionate Heart', image: 'https:
{ name: 'Secret Admirer', image: 'https:
]
},
"Sombra & Sol": {
desc: "Smoky mezcal and sun-kissed citrus in every glass.",
recipes: [
{ name: 'Desert Smoke', image: 'https:
{ name: 'Painted Desert', image: 'https:
{ name: 'Smoldering Citrus', image: 'https:
{ name: 'Smoky Lime', image: 'https:
{ name: 'Fire & Fruit', image: 'https:
]
},
"Flora-Bitter": {
desc: "Botanical vodka and bitter Campari in floral harmony.",
recipes: [
{ name: 'Flora-Glow', image: 'https:
{ name: 'Bitter Side', image: 'https:
{ name: 'Floral Negroni', image: 'https:
{ name: 'North Star', image: 'https:
]
},
"Punt, Pass, & Pour": {
desc: "Game day reposado tequila cocktails with bold fruit flavors.",
recipes: [
{ name: 'Coin Toss', image: 'https:
{ name: 'Pocket Protector', image: 'https:
{ name: 'Wide Receiver', image: 'https:
{ name: 'Blindside Blitz', image: 'https:
{ name: 'Two-Point Conversion', image: 'https:
]
},
"Turf & Tonic": {
desc: "Bourbon-forward pours built for game day gatherings.",
recipes: [
{ name: 'Red Zone', image: 'https:
{ name: 'Gridiron Fizz', image: 'https:
{ name: 'Halftime Green Tea', image: 'https:
{ name: 'Ruby Scrimmage', image: 'https:
{ name: 'Almond Field Goal', image: 'https:
{ name: 'Fullback', image: 'https:
]
},
"13 Botanicals": {
desc: "Cynar and brandy-driven cocktails with herbal, bitter depth.",
recipes: [
{ name: 'Venetian Brandy', image: 'https:
{ name: 'Artichoke Martini', image: 'https:
{ name: 'Sour Monk', image: 'https:
{ name: 'The Golden Bitter', image: 'https:
{ name: 'The Dry Side', image: 'https:
]
}
};
